 ...
 */
package cn.south.express.express.receiveexpress.enums;
...
public enum ReceiveExpressExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        ReceiveExpressExceptionEnum(Integer code, String message) {
        this.code = code;
