 ...
 */
package cn.south.express.express.takeexpressdelivery.enums;
...
public enum TakeExpressDeliveryExceptionEnum implements AbstractBaseExceptionEnum {
    ...
    private final String message;
        TakeExpressDeliveryExceptionEnum(Integer code, String message) {
        this.code = code;
